...
tips：建议使用电脑查看本指南，手机建议使用WPS打开，不要用QQ直接看；本指南中蓝字为[超链接](#购前必看如何食用本指南)，均可点击。

### 1.确定需求

请仔细思考自己的学习与游戏需求，并结合下表判断自己所需的硬件配置。目前笔记本的CPU性能基本无法构成瓶颈，一般情况下只需关注其搭载的显卡。具体选择建议详见[笔记本电脑的选择部分](#笔记本电脑的选择)
